...
cp "${SRC_DIR}/EXTERNAL-RUNNER.md"       "${KIT_DIR}/EXTERNAL-RUNNER.md"
cp "${SRC_DIR}/EXTERNAL-RUNNER-RESULT-TEMPLATE.md" "${KIT_DIR}/EXTERNAL-RUNNER-RESULT-TEMPLATE.md"
cp "${SRC_DIR}/external-runner-dry-run.sh" "${KIT_DIR}/external-runner-dry-run.sh"
cp "${SRC_DIR}/VERSION"                  "${KIT_DIR}/VERSION"
chmod 755 "${KIT_DIR}/external-runner-dry-run.sh"
